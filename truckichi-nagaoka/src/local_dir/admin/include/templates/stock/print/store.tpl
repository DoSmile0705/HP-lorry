...
<div class="wrapper print print_b">
  <div class="container">
      ...
      <div class="item_disc_board">
        ...
        <div class="disc_box">
          ...
          <p class="price_box_heading"><b>業販価格</b></p>
          <div class="price_box">
            <p class="price_ttl price_ttl_l">
              税込価格
              <p class="price">
            <!--HP{if !empty($carInfoDetail.display_price_business)}HP-->
              <!--HP{if $carInfoDetail.price_business == -1}HP-->
                </p><!--HP{$carInfoDetail.display_price_business}HP-->
              <!--HP{elseif $carInfoDetail.price_business < 10000}HP-->
                <span class="txt_l"><!--HP{$carInfoDetail.display_price_business|replace:'円':'</span>円'}HP--></p>
              <!--HP{else}HP-->
                <span class="txt_l"><!--HP{$carInfoDetail.display_price_business|replace:'.':'</span><span>.'|replace:'万円':'</span>万円'}HP--></p>
              <!--HP{/if}HP-->
            <!--HP{else}HP-->
            </p>－
            <!--HP{/if}HP-->
          ...
          <div class="price_box">
              <p class="price_ttl">
                税抜価格
                <p class="price">
              <!--HP{if !empty($carInfoDetail.display_price_business_ex) && $carInfoDetail.price_business != -1}HP-->
                  <!--HP{$carInfoDetail.display_price_business_ex}HP-->
              <!--HP{else}HP-->
                ―
              <!--HP{/if}HP-->
                </p>
          ...
          <div class="price_box_wrap price_box_wrap-ippan">
          <p class="price_box_heading"><b>一般価格（参考価格）</b></p>
          <div class="price_box">
            <p class="price_ttl">
              支払総額（税込）
              <!--HP{if !empty($carInfoDetail.display_total_pay_base)}HP-->
                <!--HP{if $carInfoDetail.total_pay_base == -1}HP-->
                  <p><!--HP{$carInfoDetail.display_total_pay_base}HP--></p>
                <!--HP{else}HP-->
                <p class="price">
                  <!--HP{$carInfoDetail.display_total_pay_base}HP-->
                </p>
                <!--HP{/if}HP-->
              <!--HP{else}HP-->
                  <p>－</p>
          ...
          <div class="price_box">
            <p class="price_ttl">
              ...
              <!--HP{if !empty($carInfoDetail.display_price) && $carInfoDetail.total_pay_base!=-1}HP-->
                <p class="price"><!--HP{$carInfoDetail.display_price}HP--></p>
              <!--HP{else}HP-->
                ―
              <!--HP{/if}HP-->
            </p>
          ...
          <div class="price_box">
            <p class="price_ttl">
              諸費用（税込）
              <p class="price">
              <!--HP{if !empty($carInfoDetail.display_price) && $carInfoDetail.miscellaneous_expenses!=-1}HP-->
                <!--HP{$carInfoDetail.display_miscellaneous_expenses}HP-->
              <!--HP{else}HP-->
                ―
              <!--HP{/if}HP-->
              </p>
        ...
        <p class="caption_ttl">※仕上げ中の為、価格・作業状況をご確認下さい。</p>
        </div>
        </div>
      </div>
...
<div class="pagebreak"></div>
      ...
      <div class="category_ttl for_customer">
        <p>お客様用</p>
      </div>
      <div class="option_block">
        <ul>
          <li>
            <span>本体価格</span>
            <div class="btn_slide" id="makeImg2">
              <input type="checkbox" id="btn_slide2" checked="">
                <label for="btn_slide2">
                  <div id="btn_slide2_box"><span></span></div>
                </label>
            </div>
...
<!--安心プラン追加　ここから-->
      <div class="print_price_flex jsc_print_style">
...
<div class="pagebreak"></div>
      <div>
        ...
        <!--HP{else}HP-->
        <img src="/uploads/vt_car_info_state_table_picture_<!--HP{$carInfoDetail.virtual_row_id|string_format:"%010d"}HP-->" calt="状態表">
      <!--HP{/if}HP-->
      </div>
      <!--HP{/if}HP-->
